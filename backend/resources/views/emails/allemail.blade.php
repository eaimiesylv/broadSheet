...
<body style="background-color:#EDF2F7;">
   ...
   <h4 style="text-align:center;font-weight:normal">
			...
			If you do not wish to be getting emails from us, click here to <a href="">unsubscribe</a>
   </h4>-->
 
				
				<p style="text-align:center;margin-top:1em;padding-bottom:2em;font-size:12px !important">© {{ date('Y') }} {{ config('app.name') }} 
				10496 Leon RD,Cattaraugus
				 NY UK 14719, USA<br>
				 +1 (352) 282-0334<br>
				support@bitbullcoinage.com
				</p>
